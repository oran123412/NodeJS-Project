...
import adminOrBizWithIdCheckMiddleware from "../../middlewares/adminOrBizWithIdCheckMiddleware.mw.js";
import isAdminMiddleware from "../../middlewares/isAdmin.mw.js";
import validateBizNumber from "../../middlewares/bizNumber.mw.js";
import bizNumberSchema from "../../validation/joi/cards/bizNumberUnique.js";
...
router.patch(
  ...
  objectIdParamsValidationMiddleware,
  isAdminMiddleware,
  validateBizNumber(bizNumberSchema),
  patchBizNumberController
);
...
router.delete(
  ...
  authMiddleware,
  objectIdParamsValidationMiddleware,
  adminOrBizWithIdCheckMiddleware,
  deleteCardController
);
